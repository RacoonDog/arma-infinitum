...
public class ArmaInfinitum implements ModInitializer {
    ...
    public static final GameRules.Key<GameRules.BooleanRule> BOW_MULTISHOT_RANDOM = GameRuleRegistry.register("bowMultishotRandom", GameRules.Category.MISC, GameRuleFactory.createBooleanRule(false));
    public static final GameRules.Key<GameRules.BooleanRule> CROSSBOW_MULTISHOT_RANDOM = GameRuleRegistry.register("crossbowMultishotRandom", GameRules.Category.MISC, GameRuleFactory.createBooleanRule(true));
